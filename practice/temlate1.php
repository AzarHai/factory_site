...
<div id="categoriesSection" style="display: none;margin-left: 20px;">
    <p style="font-size: 1em;"><strong>Категория насоса по отрасли:</strong><?php echo htmlspecialchars($row['category']); ?></p>
    <p style="font-size: 1em;"><strong>Категория насоса по стране:</strong><?php echo htmlspecialchars($row['country']); ?></p>
    <p style="font-size: 1em;"><strong>Категория насоса по конструкции:</strong><?php echo htmlspecialchars($row['category1']); ?></p>
    <p style="font-size: 1em;"><strong>Категория погруженность под уровень:</strong><?php echo htmlspecialchars($row['category2']); ?></p>
    <p style="font-size: 1em;"><strong>Категория количество рабочих колес:</strong><?php echo htmlspecialchars($row['category3']); ?></p>
    <p style="font-size: 1em;"><strong>Категория конструкция рабочего класса:</strong><?php echo htmlspecialchars($row['category4']); ?></p>
</div>
<!-- Блок с контентом -->
