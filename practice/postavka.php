...
<head>
  ...
  .search-button1 {
    ...
    input[type="text1"] {
      ...
      /* Стили для зума изображений при наведении */
      .zoom {
            transition: transform 0.2s; /* Переход для плавного зума */
        }
  ...
  <body style="background-color:#0f5e9c;">
    ...
    <header class="sticky-header">
     ...
     <div class="modal fade" id="loginModal" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
        ...
        <div class="row">
        <h style="text-align: center; font-weight: bold;font-size: 34px;">Поставщики</h>
    <div class="col-md-4 mb-4">
        <img src="Lead_Logo_1x1_1-640x320.jpg" class=" zoom img-fluid" alt="Изображение 1">
        <div class="card-body">
          <h5 class="card-title text-indent">Lead</h5>
          <a class="card-text text-indent1" href="http://www.leadmetrology.com/">www.leadmetrology.com</a>
      </div>
    </div>
    <div class="col-md-4 mb-4">
        <img src="Mahr-logo-1000-1000-640x320.jpg" class="zoom img-fluid" alt="Изображение 2">
        <div class="card-body">
          <h5 class="card-title text-indent">Mahr</h5>
          <a class="card-text text-indent1" href="http://www.mahr.com/">www.mahr.com</a>
      </div>
    </div>
    <div class="col-md-4 mb-4">
        <img src="Octagon_Logo_1x1_2-640x320.jpg" class="zoom img-fluid" alt="Изображение 3">
        <div class="card-body">
          <h5 class="card-title text-indent">Octagon</h5>
          <a class="card-text text-indent1" href="http://www.octagon.co.in/">www.octagon.co.in</a>
      </div>
    </div>
    <div class="col-md-4 mb-4">
        <img src="Sanying_Logo_1x1-380x190.jpg" class="zoom img-fluid" alt="Изображение 2">
        <div class="card-body">
          <h5 class="card-title text-indent">Sanying</h5>
          <a class="card-text text-indent1" href="http://www.en.sypi.com/">www.en.sypi.com</a>
      </div>
    </div>
    <div class="col-md-4 mb-4">
        <img src="Trioptics-Logo-1000x1000-640x320.jpg" class="zoom img-fluid" alt="Изображение 2">
        <div class="card-body">
          <h5 class="card-title text-indent">Trioptics</h5>
          <a class="card-text text-indent1" href="http://www.trioptics.com/">www.trioptics.com</a>
      </div>
    </div>
    <div class="col-md-4 mb-4">
        <img src="Tztek_Logo_1x1_1-340x170.png" class="zoom img-fluid" alt="Изображение 2">
        <div class="card-body">
          <h5 class="card-title text-indent">Tztek</h5>
          <a class="card-text text-indent1" href="http://www.tztek.com/">www.tztek.com</a>
      </div>
    </div>
    <div class="col-md-4 mb-4">
        <img src="Wale_Logo_1x1-450x225.jpg" class="zoom img-fluid" alt="Изображение 2">
        <div class="card-body">
          <h5 class="card-title text-indent">Wale</h5>
          <a class="card-text text-indent1" href="http://www.walemeasure.com/">www.walemeasure.com</a>
      </div>
    </div>
    <div class="col-md-4 mb-4">
        <img src="Werth-logo-1000-1000-640x320.jpg" class="zoom img-fluid" alt="Изображение 2">
        <div class="card-body">
          <h5 class="card-title text-indent">WERTH Messtechnik</h5>
          <a class="card-text text-indent1" href="www.werth.de">www.werth.de</a>
      </div>
    </div>
    <div class="col-md-4 mb-4">
        <img src="Accurate_Logo_1x1-640x320.jpg" class="zoom img-fluid" alt="Изображение 2">
        <div class="card-body">
          <h5 class="card-title text-indent">Accurate</h5>
          <a class="card-text text-indent1" href="www.accurategauging.com">www.accurategauging.com</a>
      </div>
    </div>
  </div>
          </section>
