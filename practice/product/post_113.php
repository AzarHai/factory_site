...
<head>
  ...
  .search-button1 {
    ...
    input[type="text1"] {
        ...
        line-height: 0.8;       /* уменьшение межстрочного интервала */
    }
    </style>
    <link
...
<div class="center-content">
                                <img src='../uploads/бр.webp' alt='Изображение поста' width="700" height="400">
                            </div>
            <h1 class="center-content">Пневмоприводные насосы Husky</h1>
            <div class="center-content1">
            <button id="showContentButton">Показать контент</button>
            <button id="showCategoriesButton" disabled>Показать категории</button>
</div>
<br><br>
<div id="categoriesSection" style="display: none;margin-left: 20px;">
    <p style="font-size: 1em;"><strong>Категория насоса по отрасли:</strong>Производство удобрений</p>
    <p style="font-size: 1em;"><strong>Категория насоса по стране:</strong>Китай</p>
    <p style="font-size: 1em;"><strong>Категория насоса по конструкции:</strong>Вихревые насосы</p>
    <p style="font-size: 1em;"><strong>Категория погруженность под уровень:</strong>Поверхностные несамовсасывающие насосы</p>
    <p style="font-size: 1em;"><strong>Категория количество рабочих колес:</strong>Многоступенчатые насосы</p>
    <p style="font-size: 1em;"><strong>Категория конструкция рабочего класса:</strong>Насосы с вихревым рабочим колесом</p>
</div>
<!-- Блок с контентом -->
<div id="contentSection" style="display: none;margin-left: 20px;">
<pre style="font-size: 1em;word-wrap: break-word;white-space: pre-wrap;">Преимущества насоса:<br />
...
Постоянное распыление воздуха.</pre>
</div>
        <br></br>
            </article>
</section>
...
// Проверяем localStorage на наличие состояния контента
const isContentVisible = localStorage.getItem('contentVisible') === 'true';

// Если контент был видим при последнем посещении, показываем его
if (isContentVisible) {
    contentSection.style.display = 'block';
    showContentButton.disabled = true;
    showCategoriesButton.disabled = false;
} else {
    categoriesSection.style.display = 'block';
    showCategoriesButton.disabled = true;
    showContentButton.disabled = false;
}

// Событие для кнопки "Показать контент"
...
// Событие для кнопки "Показать категории"
