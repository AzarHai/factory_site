...
<head>
    ...
    transform: translateX(-50%); /* Сдвигаем влево на половину ширины элемента */
    max-width: 1200px; /* Максимальная ширина */
    width: 100%; /* Занимать всю доступную ширину */
    z-index: 1000; /* Поднимаем над остальными элементами */
    border-top: 1px solid #ccc; /* Верхняя граница для разделения секций */
  }
  body {
  ...
  footer {
    ...
    box-shadow: 0 0px 10px rgba(0, 0, 0, 0.1); /* Тень вверху */
    padding: 10 px 10px; /* Отступы сверху и снизу */
    text-align: center; /* Центрируем содержимое */
    position: absolute; /* Фиксированное положение */
  ...
  .dropdown:hover .dropdown-menu {
      ...
      .search-button {
          width: 36px; /* Размер кнопки поиска */
          height: 36px; /* Размер кнопки поиска */
          display: flex;
          align-items: center;
...
<section style="margin-bottom: 0;">
        <h1>О компании</h1>
        <p><strong>ЗАО Производственная фирма «Дора»</strong> - ведущий производитель химических насосов для промышленности, работающий на рынке с 2004 года. Мы специализируемся на разработке, производстве и поставке высококачественного оборудования для перекачки нейтральных, агрессивных и взрывоопасных жидкостей, что делает нас надежным партнером для многих отраслей промышленности.</p>

        <h2>Наша миссия</h2>
        <p>Мы стремимся обеспечивать наших клиентов инновационными и надежными решениями, которые способствуют повышению эффективности и безопасности производственных процессов. Наша миссия - удовлетворение потребностей клиентов за счет высокого качества продукции и передовых технологий.</p>

        <h2>Наши ценности</h2>
        <ul>
            <li><strong>Качество:</strong> Мы уделяем особое внимание качеству каждой детали, используемой в производстве наших насосов, чтобы гарантировать их долговечность и надежность.</li>
            <li><strong>Инновации:</strong> Мы постоянно ищем новые способы улучшения нашей продукции и внедряем передовые технологии в наши процессы.</li>
            <li><strong>Безопасность:</strong> Безопасность наших продуктов и производственных процессов является нашим приоритетом, и мы строго соблюдаем все отраслевые стандарты и нормы.</li>
            <li><strong>Клиентоориентированность:</strong> Мы ценим каждого нашего клиента и стремимся к установлению долгосрочных партнерских отношений, предлагая индивидуальные решения и поддержку на каждом этапе сотрудничества.</li>
        </ul>

        <h2>Наша продукция</h2>
        <p>Мы предлагаем широкий ассортимент химических насосов, включая:</p>
        <ul>
            <li><strong>Ламинарные насосы ОНЛ:</strong> Подходят для транспортировки сред с содержанием твердых компонентов до 40...50 мм при концентрации до 45%.</li>
            <li><strong>Центробежные моноблочные химические насосы ХМ:</strong> Идеальны для работы с жидкостями, содержащими твердые включения размером до 0,2 мм при максимальной концентрации 0,1 мм.</li>
            <li><strong>Самовсасывающие моноблочные центробежные насосы ХМс и вихревые ВКс:</strong> Эффективны для откачивания жидкостей из емкостей сверху, с высотой самовсасывания до 8 метров.</li>
            <li><strong>Погружные пневмоприводные насосы Хаски:</strong> Обеспечивают герметичное самовсасывание и высокую надежность.</li>
        </ul>

        <h2>Наши технологии</h2>
        <p>Мы используем только высококачественные материалы, такие как нержавеющая сталь марок К, Е, устойчивых к воздействию химических веществ, и передовые технологии для обеспечения надежности и долговечности нашей продукции. Наши насосы оснащены надежными торцовыми уплотнениями фирмы Джон Крейн и взрывозащищенными электродвигателями, что делает их безопасными и эффективными в любых условиях эксплуатации.</p>

        <h2>Почему выбирают нас?</h2>
        <ul>
            <li><strong>Опыт и профессионализм:</strong> Наша команда состоит из опытных инженеров и специалистов, которые обладают глубокими знаниями и навыками в области производства химических насосов.</li>
            <li><strong>Индивидуальный подход:</strong> Мы предлагаем индивидуальные решения, адаптированные под конкретные потребности каждого клиента.</li>
            <li><strong>Гарантия качества:</strong> Мы гарантируем высокое качество нашей продукции и предоставляем надежную гарантию на все наши изделия.</li>
            <li><strong>Поддержка клиентов:</strong> Мы обеспечиваем полное сопровождение и поддержку наших клиентов на всех этапах - от выбора оборудования до его монтажа и обслуживания.</li>
        </ul>

        <h2>Свяжитесь с нами</h2>
        <p>Если у вас есть вопросы или вы хотите получить дополнительную информацию о нашей продукции, пожалуйста, свяжитесь с нами по телефону +7 (XXX) XXX-XX-XX или по электронной почте info@dora.com. Мы будем рады помочь вам найти идеальное решение для ваших нужд.</p>
</section>
