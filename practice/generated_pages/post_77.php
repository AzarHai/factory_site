...
<section style="margin-bottom: 0;">
            ...
            <div class="center-content">
                                        <img src='../uploads/1T4oqmot3kw.jpg' alt='Изображение поста' width="700" height="400">
                                        </div>
                    <h1 class="center-content">Информация</h1>
            </div>
            <pre style="font-size: 1em;word-wrap: break-word;white-space: pre-wrap; ">аыва</pre>
            </div>
            <br></br>
                        <br></br>
            <br></br>
