...
<section style="margin-bottom: 0;">
            ...
            <div class="center-content">
                                        <img src='../uploads/slider-2.jpg' alt='Изображение поста' width="700" height="400">
                                        </div>
                    <h1 class="center-content">аааааааааааа</h1>
            </div>
            <pre style="font-size: 1em;word-wrap: break-word;white-space: pre-wrap; ">ааааааааааа</pre>
            </div>
            <br></br>
                        <br></br>
            <br></br>
